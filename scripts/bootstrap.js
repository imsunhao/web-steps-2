...
const organizationsName = 'web-steps-2'
...
files.forEach(shortName => {
  ...
  if (args.force || !pkgExists) {
    const json = {
      ...
      repository: {
        type: 'git',
        url: `git+https://github.com/${author}/${organizationsName}.git`
      },
      keywords: [],
      author,
      license: 'MIT',
      bugs: {
        url: `https://github.com/${author}/${organizationsName}/issues`
      },
      homepage: `https://github.com/${author}/${organizationsName}/tree/dev/packages/${shortName}#readme`
    }
